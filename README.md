...
| ----------- | --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | --------- | ------------ | ----------- |
| 1           | HTML och Git                      | HTML är webbens språk för struktur och innehåll. Grundläggande versionshantering i GitHub. *Design:* Grundläggande - grafisk formgivning    | HT:1      | individuellt | 5 |
...
| 4           | Fortsättning JavaScript           | Asynkron kod med JavaScript, visauliser data från API:er, filformaten JSON och XML.                                                         | VT:1      | individuellt | 6 |
| 5           | Hosting, CMS och Wordpress        | Introduktion till webbservrar och publiceringssystem, arbeta i team, publicera med Wordpress och statisk sidgenerator                       | VT:2      | grupp        | 5 |
| 6           | Fullstack PHP                     | Fullstack applikation med PHP och MySQL. Sessionshantering, autentisering, sökmotoroptimering. *Design:* CSS-Ramverk (Bootstrap).           | VT:3      | individuellt | 9 |
